		<section class="ovberflow-hidden space"  >
    ...
    <section class="space" id="testi-sec" style="background-color: #F8F8F8;">
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-md">
                    <div class="title-area text-center text-md-start"><span class="sub-title"><img
            ...
            <div class="container">
                <div class="counter-card-wrap style2">
                    ...
                    <div class="counter-card">
                        ...
                        <div class="media-body"><h4 class="box-number text-white"><span class="counter-number">10</span>+
                            </h4>
                    ...
                    <div class="counter-card">
                        ...
                        <div class="media-body"><h4 class="box-number text-white"><span class="counter-number">5</span>+
                            </h4>
                            ...
                            <div class="contact-media-wrap"><h3 class="box-title">Quick Contact</h3>
                                ...
                                <div class="contact-media">
                                    ...
                                    <div class="media-body"><h4 class="box-label">Email Us:</h4>
                                        <p class="box-text"><a href="info@rayandsons.co.za">info@rayandsons.co.zw</a></p>
                                    </div>
                                </div>
                            </div>
