            ...
            <div class="footer-contact-wrap">
                ...
                <div class="footer-contact">
                    ...
                    <div class="media-body"><h3 class="box-title">Email Us:</h3>
                        <p class="box-text"><a href="mailto:info@rayandsons.co.za">info@rayandsons.co.za</a></p></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-md-6 col-xl-auto">
                    <div class="widget widget_nav_menu footer-widget"><h3 class="widget_title"><img
                        ...
                        <div class="menu-all-pages-container">
                            <ul class="menu">
                                <li><a href="service-details.html">Plumbing Installations</a></li>
                                <li><a href="service-details.html">Drainage Services</a></li>
                                <li><a href="service-details.html">Plumbing Maintenances</a></li>
        ...
        <div class="container">
            <div class="row gy-2 align-items-center">
                <div class="col-md-6"><p class="copyright-text">Copyright <i class="fal fa-copyright"></i> <script>document.write(new Date().getFullYear())</script>
                    <a
                            href="home-handyman.html">Ray and Sons Plumbing (Pty) Ltd.</a> All Rights Reserved.</p></div>
