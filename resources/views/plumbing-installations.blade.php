            ...
            <div class="row">
                <div class="col-xxl-8 col-lg-7">
                    ...
                    <div class="page-single mb-30">
                                ...
                                <h2 class="h3 sec-title page-title">Reliable Residential Plumbing.</h2>

                            <p class="">We know how stressful plumbing issues can be — especially in your home. That’s why our trusted team treats your space with the same care and respect we’d give our own. From clean work areas to clear communication, we’re here to fix the problem and ease the worry.</p>
                            <p class="mb-30">Your safety and comfort are our top priorities — every step of the way.</p>
                                    <div class="pe-xxl-5">
                    ...
                    <div class="tab-content" id="industrial" style="display: none;">
                        <div class="page-single mb-30">
                            <div class="page-content">
                                <h2 class="h3 sec-title page-title">Industrial Plumbing Solutions.</h2>

                                <p class="">When it comes to industrial plumbing, you need more than just a plumber — you need a reliable partner who understands complex systems, safety compliance, and minimal downtime. Our team specializes in delivering high-performance plumbing solutions built for the demands of industrial facilities.</p>
                                ...
                                <h4 class="mt-40 mb-4">Our Industrial Services Include:</h4>


                                <div class="choose-feature-wrap">
                                    <div class="choose-feature">
                                        <div class="box-icon"><img src="assets/img/icon/choose_feature_1.svg" alt="Icon"></div>
                                        <h3 class="box-title">High pressure water mains</h3></div>
                                    <div class="choose-feature">
                                        <div class="box-icon"><img src="assets/img/icon/choose_feature_2.svg" alt="Icon"></div>
                                        <h3 class="box-title">Under and above ground drainage systems</h3></div>
                                    <div class="choose-feature">
                                        <div class="box-icon"><img src="assets/img/icon/choose_feature_3.svg" alt="Icon"></div>
                                        <h3 class="box-title">Water Meter installation</h3></div>
                                    <div class="choose-feature">
                                        <div class="box-icon"><img src="assets/img/icon/choose_feature_4.svg" alt="Icon"></div>
                                        <h3 class="box-title">High rise water mains and sewer systems</h3></div>
                                    <div class="choose-feature">
                                        <div class="box-icon"><img src="assets/img/icon/choose_feature_4.svg" alt="Icon"></div>
                                        <h3 class="box-title">Back-flow prevention systems</h3></div>
                                    <div class="choose-feature">
                                        <div class="box-icon"><img src="assets/img/icon/choose_feature_4.svg" alt="Icon"></div>
                                        <h3 class="box-title">Stainless steel pipework and fittings</h3></div>
                                    <div class="choose-feature">
                                        <div class="box-icon"><img src="assets/img/icon/choose_feature_4.svg" alt="Icon"></div>
                    ...
                    <div class="tab-content" id="commercial" style="display: none;">
                        <div class="page-single mb-30">
                            <div class="page-content">
                                <h2 class="h3 sec-title page-title">Commercial Plumbing You Can Rely On.</h2>
{{--                                <p>Professional, Efficient & Built for Business.</p>--}}

                                <p class="">Plumbing issues in a commercial space don’t just cause inconvenience — they can disrupt operations, impact customers, and affect your bottom line. That’s why our experienced team delivers fast, dependable plumbing services tailored for businesses like yours.

                                    We treat your property with professionalism and precision, ensuring minimal downtime and maximum peace of mind.</p>
                                ...
                                <h4 class="mt-40 mb-4">Our Commercial Services Include:</h4>
